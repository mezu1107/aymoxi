    ...
    <main className="pt-28 pb-20 bg-sand/30 min-h-screen">
      <div className="mx-auto max-w-3xl px-6">
        <div className="text-center">
          ...
          <h1 className="mt-4 font-display text-4xl font-black text-espresso sm:text-5xl">Schedule your discovery call</h1>
          <p className="mt-3 text-foreground/70">Pick a slot that works. We'll send a confirmation to your email.</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="mt-10 rounded-3xl border border-espresso/10 bg-white p-6 shadow-soft sm:p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <S label="Meeting type *" name="meeting_type" required options={["Zoom / Video call","Google Meet","Phone call","WhatsApp","On-site (Faisalabad)"]} />
