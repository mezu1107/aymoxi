...
export const Route = createFileRoute("/clients/")({
  head: () => ({
    meta: [
      { title: "Client Portal Login — AYMOXI" },
      { name: "description", content: "Sign in to the AYMOXI client portal to track projects, tasks, invoices, documents and messages in one place." },
      { property: "og:title", content: "Client Portal Login — AYMOXI" },
      { property: "og:description", content: "Track your projects, invoices and documents in the AYMOXI client portal." },
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            Need an account? Contact us at <a href="tel:+17207941888" className="font-bold text-foreground">+1 720 794 1888</a>
          </p>
        </div>
      </div>
    </div>
