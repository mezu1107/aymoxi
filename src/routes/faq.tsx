...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQ — AYMOXI" },
      { name: "description", content: "Answers to common questions about pricing, timelines, process and support when working with AYMOXI." },
      { property: "og:title", content: "FAQ — AYMOXI" },
      { property: "og:description", content: "Answers to common questions about pricing, timelines, process and support when working with AYMOXI." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          mainEntity: [
            ...
            {
              "@type": "Question",
              name: "What services does AYMOXI offer?",
              acceptedAnswer: {
                "@type": "Answer",
