...
function TeamPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Our Team"
        title="The people behind AYMOXI."
        description="A multidisciplinary team combining vision, engineering excellence and disciplined delivery."
      />
                    ...
                    <div className="relative aspect-square overflow-hidden bg-sand">
                      {m.photo_url ? (
                        ...
                        <div className="grid h-full w-full place-items-center bg-gradient-to-br from-[#2e6b16] to-[#0a2205]">
                          <span className="font-display text-4xl font-black text-copper">{m.name.slice(0, 1)}</span>
                        </div>
                      )}
