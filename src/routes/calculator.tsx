...
export const Route = createFileRoute("/calculator")({
  head: () => ({
    meta: [
      { title: "Instant Project Cost Calculator — AYMOXI" },
      { name: "description", content: "Build your scope and see a transparent price in seconds. Website, e-commerce, mobile app, AI automation and digital marketing pricing in USD or PKR — no sales call required." },
      { property: "og:title", content: "Instant Project Cost Calculator — AYMOXI" },
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_360px]">
            ...
            <aside className="lg:sticky lg:top-24 lg:self-start">
              <div className="rounded-3xl border border-espresso/10 bg-white p-6 shadow-soft">
                ...
                >
                  <Phone className="h-3.5 w-3.5" /> Talk it through: {PHONE}
                </a>
              </div>
