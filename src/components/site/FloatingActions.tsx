    ...
    <>
      <div className="fixed bottom-[5.5rem] right-4 z-50 flex flex-col items-end gap-3 lg:bottom-6 lg:right-6">
        ...
        <a
          ...
          className={`grid h-12 w-12 place-items-center rounded-full bg-[#25D366] text-white shadow-luxury transition-all duration-300 ease-out ${
            expanded ? "translate-y-0 scale-100 opacity-100" : "pointer-events-none translate-y-6 scale-50 opacity-0"
          }`}
        >
        ...
        <button
          ...
          className={`grid h-12 w-12 place-items-center rounded-full bg-gradient-to-br from-cocoa to-espresso text-copper shadow-luxury transition-all delay-75 duration-300 ease-out ${
            expanded ? "translate-y-0 scale-100 opacity-100" : "pointer-events-none translate-y-6 scale-50 opacity-0"
          }`}
        >
