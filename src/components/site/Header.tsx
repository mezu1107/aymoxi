...
const baseNav: NavItem[] = [
  { to: "/", label: "Home" },
  {
    ...
    label: "About",
    children: [
      { to: "/about", label: "About AYMOXI", desc: "Who we are and how we work" },
      { to: "/company", label: "Our Company", desc: "Story, mission, vision & philosophy" },
      { to: "/directors", label: "Directors", desc: "Meet AYMOXI leadership" },
      { to: "/team", label: "Team", desc: "Meet our team members" },
